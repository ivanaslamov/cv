# taken from https://www.geeksforgeeks.org/python-os-path-join-method/
...
def calibrate(checker_pattern_images_dir, preview=False):
    ...
    for filename in os.listdir(checker_pattern_images_dir):
        filename = os.path.join(checker_pattern_images_dir, filename)
